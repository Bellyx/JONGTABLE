...
if(isset($_POST["submit"])){
  if($_POST["id"] == ""){
    saveAdmin($_POST["username"],$_POST["password"],$_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["email"],$_FILES["admin_profile"]["name"]);
  }else{
    editAdmin($_POST["id"],$_POST["username"],$_POST["password"],$_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["email"],$_FILES["admin_profile"]["name"]);
  }
}
if($_GET["id"] == ""){
  $txtHead = "เพิ่ม ผู้ดูแลระบบ";
}else{
  $txtHead = "แก้ไข ผู้ดูแลระบบ";
}
?>
<body>
