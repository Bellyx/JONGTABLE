...
?>
<?php 
$historyBookingUser = getHistoryBookingUser($_SESSION["id"]);
?>
<body>
    ...
    <div class="container">
      <div class="page-banner">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-md-6">
            <h1 class="text-center" style="color:white;">ประวัติการจอง</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-12 py-12">
          <table class="table">
            ...
            <tbody>
              <?php if(empty($historyBookingUser)){ ?>
                <?php echo "<h3>ไม่พบข้อมูล</h3>";?>
              <?php }else{?>
                <?php $i=1;?>
                <?php foreach($historyBookingUser as $data){ ?>
                  <tr>
