...
if(isset($_POST["submit"])){
  editTaker($_POST["id"],$_POST["username"],$_POST["password"],$_POST["firstname"],$_POST["lastname"],$_POST["telephone"],$_POST["email"],$_FILES["taker_profile"]["name"]);
}
?>
    ...
    <div class="container">
      <div class="page-banner">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-md-6">
            <h1 class="text-center" style="color:white;">แก้ไขข้อมูล Taker</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <form name="regis" id="regis" action="" method="post" class="contact-form py-12 px-lg-12" enctype="multipart/form-data">
            ...
            <div class="row form-group">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="text" id="fname" name="username" class="form-control" value="<?php echo $currentTaker['username'];?>">
              </div>
              <div class="col-md-6">
            ...
            <div class="row form-group">
              <div class="col-md-6 mb-3 mb-md-0">
                ...
                <input type="text" id="fname" name="firstname" class="form-control" value="<?php echo $currentTaker['firstname'];?>">
              </div>
              <div class="col-md-6">
                <label class="text-black" for="lname">นามสกุล</label>
                <input type="text" id="lname" name="lastname" class="form-control" value="<?php echo $currentTaker['lastname'];?>">
              </div>
            </div>
            <div class="row form-group">
              <div class="col-md-6 mb-3 mb-md-0">
                <label class="text-black" for="fname">หมายเลขโทรศัพท์</label>
                <input type="text" id="fname" name="telephone" class="form-control" value="<?php echo $currentTaker['telephone'];?>">
              </div>
              <div class="col-md-6">
                <label class="text-black" for="lname">อีเมล</label>
                <input type="email" id="lname" name="email" class="form-control" value="<?php echo $currentTaker['email'];?>">
              </div>
            </div>

           <!---- <div class="row form-group">
              <div class="col-md-6 mb-3 mb-md-0">
                <label class="text-black" for="fname">เลขบัญชี</label>
                <input type="text" id="fname" name="bookbank" class="form-control" value="<?php echo $currentTaker['bookbank'];?>">
              </div>
