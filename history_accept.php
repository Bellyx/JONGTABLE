...
?>
<?php 
$historyBookingAccept = getHistoryBookingAccept($_SESSION["id"]);
?>
<body>
    ...
    <div class="container">
      <div class="page-banner">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-md-6">
            <h1 class="text-center" style="color:white;">ประวัติการรับงาน</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-12 py-12">
          <table class="table">
            ...
            <tbody>
              <?php if(empty($historyBookingAccept)){ ?>
                <?php echo "<h3>ไม่พบข้อมูล</h3>";?>
              <?php }else{?>
                <?php $i=1;?>
                <?php foreach($historyBookingAccept as $data){ ?>
                  <tr>
                    ...
                    <td style="text-align:right;">
                      <?php if($data["booking_status"] == 2){ ?>
                        <a href="edit_complete.php?id=<?php echo $data['id'];?>" class="btn btn-success">ส่งมอบ</a>
                      <?php } ?>
                      <a href="history_detail.php?id=<?php echo $data['id'];?>" class="btn btn-info">รายละเอียด</a>
                    </td>
                  </tr>
                  <?php $i++; ?>
                <?php } ?>
