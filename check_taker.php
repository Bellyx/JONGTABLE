...
if(isset($_POST["success"])){
  completeTaker($_POST["id"]);
}


if(isset($_POST["cancel"])){
  cancelTaker($_POST["id"]);
}
        ...
        <div class="col-lg-6 py-3">
          ...
          <form name="regis" id="regis" action="" method="post" class="contact-form py-12 px-lg-12" enctype="multipart/form-data">
            ...
            <div class="row form-group mt-4">
              <div class="col-md-12">
                <?php if($currentTaker["taker_actives"] == 1){ ?>
                  <input type="submit" name="success" value="อนุมัติ" class="btn btn-success">
                  <input type="submit" name="cancel" value="ไม่อนุมัติ" class="btn btn-warning">
                <?php } ?>
